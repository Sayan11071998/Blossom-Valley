...
public class InventoryModel
{
    ...
    public InventoryModel() => InitializeSlots();

    public InventoryModel(ItemSlotData[] toolSlots, ItemSlotData equippedToolSlot, ItemSlotData[] itemSlots, ItemSlotData equippedItemSlot)
    {
    ...
    public void LoadInventoryData(ItemSlotData[] toolSlots, ItemSlotData equippedToolSlot, ItemSlotData[] itemSlots, ItemSlotData equippedItemSlot)
    {
        this.toolSlots = toolSlots ?? new ItemSlotData[8];
        this.equippedToolSlot = equippedToolSlot ?? new ItemSlotData(null);
        this.itemSlots = itemSlots ?? new ItemSlotData[8];
    ...
    public ItemSlotData[] GetInventorySlots(InventorySlot.InventoryType inventoryType) => inventoryType == InventorySlot.InventoryType.Item ? itemSlots : toolSlots;

    public ItemSlotData GetEquippedSlot(InventorySlot.InventoryType inventoryType) => inventoryType == InventorySlot.InventoryType.Item ? equippedItemSlot : equippedToolSlot;

    public ItemData GetEquippedSlotItem(InventorySlot.InventoryType inventoryType) => GetEquippedSlot(inventoryType).itemData;
    public bool IsSlotEquipped(InventorySlot.InventoryType inventoryType) => !GetEquippedSlot(inventoryType).IsEmpty();
    ...
    public void TriggerInventoryChanged() => NotifyInventoryChanged();
}